...
//  SuniSoundBoard
//
//  Created by Jonathan on 13/05/24.
//
...
class SoundViewController: UIViewController {
    ...
    func configurarGrabacion() {
        do {
            ...
            settings[AVFormatIDKey] = kAudioFormatMPEG4AAC as NSNumber
            settings[AVSampleRateKey] = 44100.0 as NSNumber
            settings[AVNumberOfChannelsKey] = 2 as NSNumber
